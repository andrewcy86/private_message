...
function rwpm_add_menu()
{
	...
	$num_unread = $wpdb->get_var( 'SELECT COUNT(*) FROM ' . $wpdb->prefix . 'pm a INNER JOIN ' . $wpdb->prefix . 'pm_users b ON a.id = b.pm_id WHERE b.recipient = "' . $current_user->ID . '" AND b.deleted != "2" AND b.viewed = 0' );
	...
	<div style="width:600px;float:left">
		<form method="post" action="options.php">
			...
			<table class="form-table">
				...
				<tr>
					<th>%TITLE%</th>
					<td>Title component of system message.</td>
				</tr>
				<tr>
					<th>%BODY%</th>
					<td>Body component of system message.</td>
				</tr>
				<!-- PATT END -->
				<tr>
					<th>%BLOG_NAME%</th>
